...
?><!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"><title>Reparo Admin — Actividad</title>
...
<main class="adm-main"><div class="adm-topbar"><h1 class="adm-title">Actividad</h1></div>
<div class="adm-panel" style="padding:48px;text-align:center;color:var(--txt2);">
<span class="material-icons-round" style="font-size:44px;color:#60a5fa;">history</span>
