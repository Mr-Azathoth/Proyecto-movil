    ...
    <div id="view-servicios" class="view active">
      ...
      <div class="controls">
        <div class="search-wrap">
          ...
          <input id="search-bar" type="search" class="search-input" placeholder="Buscar por cliente, modelo, # orden..." autocomplete="off" data-lpignore="true" data-bwignore="true" data-1p-ignore data-form-type="other">
        </div>
