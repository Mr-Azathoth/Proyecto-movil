...
<aside class="adm-sidebar">
  <div class="adm-brand">
    <div class="brand-icon" style="background:linear-gradient(135deg,#7c3aed,#4f46e5);width:34px;height:34px;font-size:16px;">R</div>
    <div>
      <div style="font-weight:700;font-size:14px;color:var(--txt);">Reparo</div>
      <div style="font-size:11px;color:#7c3aed;">Administración</div>
    </div>
  </div>
  <nav class="adm-nav">
    <?php foreach ($links as $page => [$icon, $label]): ?>
    <a href="/reparo/<?= $page ?>.php" class="adm-link <?= $current === $page ? 'active' : '' ?>">
  ...
  <div class="adm-sidebar-footer">
    ...
    <a href="/reparo/admin_logout.php" class="adm-logout">
